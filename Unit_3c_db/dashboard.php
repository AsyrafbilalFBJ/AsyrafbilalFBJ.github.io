    ...
    <body>
        <nav class="navbar navbar-expand-lg bg-white sticky-top shadow-sm">
            <div class="container-fluid">
                <a class="navbar-brand" href="index.php" id="home"><img src="assets/images/logo_unit3c.png" alt="Bootstrap" width="40" height="45"></a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <span class="fs-5 text-dark">Selamat Datang User</span>
                        </li>
                    </ul>
        ...
        <div class="content d-flex">
            <div class="sideNav bg-white">
                <ul class="list-group list-group-flush text-center">
                    <li class="sideBarHome list-group-item"><a href="" id="dashboardHome" class="link-success text-decoration-none">Home</a></li>
                    <li class="sideBarKelas list-group-item"><a href="" id="dashboardKelas" class="link-success text-decoration-none">Kelas</a></li>
                </ul>
            </div>
