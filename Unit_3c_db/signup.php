...
<body>
    <div class="container">
        <div class="card p-5 position-absolute top-50 start-50 translate-middle w-25">
            ...
            <form method="post" action="action_add.php" class="mt-4 mb-4">
                <div class="mb-3">
                  <label for="inputNama" class="form-label">Nama</label>
                  <input type="nama" name="nama" class="form-control" id="inputNama" placeholder="asyraf">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3 btn-group w-100">
                    ...
                    <label class="btn btn-outline-warning" for="btnradio2">Mentor</label>
                </div>
            ...
            <hr>
                <div class="text-center">
                    <span>Sudah punya akun? <br><a href="login.php"><b>Masuk sekarang</b></a></span>
                </div>
        </div>
    </div>
</body>
